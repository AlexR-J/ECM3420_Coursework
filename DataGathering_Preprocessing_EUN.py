...
def getPlayersData():
    ...
    for division in divisions:
        ...
        scanning = True
        while(scanning == True) :
            response = requests.get("https://eun1.api.riotgames.com/lol/league/v4/entries/" + queue + str(div) + str(tier) + "?page=" + str(page) + "&api_key=" + api_key)
            requestCount +=1
    ...
    for player in newData["dataset"] :
        response2 = requests.get("https://eun1.api.riotgames.com/lol/champion-mastery/v4/scores/by-summoner/" + player["summonerId"] + "?api_key=" + api_key)
        requestCount += 1
        print("RequestCount = " + str(requestCount))
        print(response2.status_code)
        newEntry = {"masteryScore":response2.json()}
        player.update(newEntry)
        response2 = requests.get("https://eun1.api.riotgames.com/lol/champion-mastery/v4/champion-masteries/by-summoner/" + player["summonerId"] + "?api_key=" + api_key)
        requestCount += 1
        print("RequestCount = " + str(requestCount))
